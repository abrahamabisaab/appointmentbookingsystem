...
<h2 class=sign>Sign Up to provide service for patients</h2>
<span class="input__text">Name</span> 
<input type="text" class="inputs" name="name" id="name" placeholder="Your Name/ Username"/>
...
<span class="input__text">Date</span>
...
<span class="input__text">Speciality</span>
<input type="text" class="inputs" name="spec" id="spec" placeholder="Speciality"/>
<span class="input__text">Region</span>
...
<input type="submit" name="submit" id="submit" class="input1 register" value="Sign up"/>
  </form>
</div>
<div>
    <?php
